...
public class GameObjectTest extends Observer{
	...
	public void testIsInArea() {
		iBlock obj = new Block(10,20,10,1);
	...
	public void testGetX() {
		iPlayer obj = new Player(0,0,100,200);
	...
	public void testJump() {
		iPlayer obj = new Player(600,500,100,200);
		LevelLoader loader = new LevelLoader(new File("map.lvl"));
		iLevel level = new Level(loader, obj, 100, 12);
		int y = obj.getY();
		obj.setJump(false);
		obj.jump(level, this, 10, 10, iLevel.PLAYER_MOVING);
		obj.pause(100);
